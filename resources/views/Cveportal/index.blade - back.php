...
<body>	
	...
	<div id="content" class="flex-content">
		...
		<div  id="copy" style="width:92%; margin: auto;" class="container1">
			...
			<small style="font-size:10px; margin-top:-30px;display: flex;justify-content: center;align-items: center;">Last Updated on&nbsp<span id='last_updated'></span></small>
		</div>
		<!--pageElement:FOOTER-->
