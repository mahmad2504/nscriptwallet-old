...
class Cveportal extends App{
	...
	//test 
	public $url = 'https://script.google.com/macros/s/AKfycbyFOMmy36I5Th0thXnwPBDkWQyvgIyuXS5ImiqifdnKZtGoHiMO8bmJ8zGE6kFefOos/exec';
	...
	public function __construct($options=null)
    {
		...
		{
			$this->url = 'https://script.google.com/macros/s/AKfycbyFOMmy36I5Th0thXnwPBDkWQyvgIyuXS5ImiqifdnKZtGoHiMO8bmJ8zGE6kFefOos/exec';
		}
		else
			$this->url = 'https://script.google.com/macros/s/AKfycbx5raOsCH1SfPRlm34dV8vHIpyDYvm9hKh_4bAteYVruIJ7TCSs8j7UWXV6jwX_s7XJ2A/exec';
